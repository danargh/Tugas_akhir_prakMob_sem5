            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    // Weapon Name
                    Text(weapon.displayName!,style: TextStyle(color: white,fontSize: 20.sp,fontWeight: FontWeight.w900,fontStyle: FontStyle.italic),),
                    ...
                    Container(
                        ...
                        alignment: Alignment.center,
                        child: Text('${weapon.shopData!.cost}',style: TextStyle(color: white,fontSize: 17.sp),)),
                  ],
                ),
              )
            ],
